...
if checkpoint.ok:
    ...
    # info_path= /home/zsm/projects/logs/Hinge_VGG_CIFAR10_LR0.1r0.01f0.1_svd2_R2e-4_T5e-2_S0.1_A2_E300_l1_Ratio0.6090/compression_information.pt
    # os.path= <module 'posixpath' from '/home/zsm/anaconda3/envs/pytorch1.2/lib/python3.7/posixpath.py'>
    ...
    if not converging and not args.test_only:
        ...
        # args.ratio=0.609, args.stop_limit=0.1
